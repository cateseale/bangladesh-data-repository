...
##    today = str(date.today())
    file = os.path.join(os.getcwd(), 'data-repository', 'GIS','3_Mapping', '32_Map_Templates', '325_misc', '3253_element-locations', "template_positions.txt")
    return open(file, 'a+')

def createMapTemplateLocations():
    proTemplateDirectory = os.path.join(os.getcwd(), 'data-repository', 'GIS', '3_Mapping', '32_Map_Templates', '321_arcpro')
